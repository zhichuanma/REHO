...
results = pd.read_pickle(r'C:\Users\Administrator\PycharmProjects\REHO\VEO_Spain\Scenario_2\results\gwp.pickle')
...
plotting.plot_profiles(results['gwp'][0], units_to_plot, label='EN_long', color='ColorPastel', resolution='weekly').show()
