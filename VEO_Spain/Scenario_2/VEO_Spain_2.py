...
if __name__ == '__main__':
    ...
    unfixed_file = reho.results['gwp'][0]['df_Unit']
    ...
    reho.scenario['Objective'] = 'GWP'
    reho.scenario['name'] = 'gwp'
    ...
    fixed_file = reho.results['gwp'][0]['df_Unit']
    fixed_file.to_csv('./units_files/gwp.csv')

    reho.save_results(format=['xlsx', 'pickle'], filename='gwp')
