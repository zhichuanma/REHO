...
# Sankey diagram
plotting.plot_sankey(results[objective][0], label='EN_long', color='ColorPastel').show()
...
plotting.plot_profiles(results[objective][0], units_to_plot, label='EN_long', color='ColorPastel', resolution='weekly').show()
